...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            this.opcion1.BackColor = Color.HotPink;
            this.opcion2.BackColor = Color.MediumOrchid;
            this.opcion3.BackColor = Color.Orange;
            this.opcion4.BackColor = Color.DodgerBlue;
        }
        ...
        private void aumentaPuntaje()
        {
            ...
            {
                MessageBox.Show("¡Has adivinado todas las banderas!");
                Hide();
        ...
        private void restaVida()
        {
            ...
            if (numeroDeVidas == 0)
            {
                MessageBox.Show("Se acabaron las vidas");
                Hide();
                Form2 puntuacionFinalModal = new Form2(numeroPuntaje.ToString());
                puntuacionFinalModal.ShowDialog();
            }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //this.pictureBox1.Image = New System.Drawing.Bitmap(WindowsFormsApp1.Properties.Resources.ad);
